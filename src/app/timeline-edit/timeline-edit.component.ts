...
export class TimelineEditComponent implements OnInit {
  editTimelineForm;
  timelineAMod = this.datasService.timelineAMod;
  cards: Cards[] = this.timelineAMod.cardList;
  ...
  onSubmit(editTimeline) {
    ...
    if (editTimeline.name == "") {
      editTimeline.name = this.datasService.timelineAMod.name;
      this.timelineAMod = this.datasService.timelineAMod;
    }

    if (editTimeline.category == "") {
      editTimeline.category = this.datasService.timelineAMod.category;
      this.timelineAMod = this.datasService.timelineAMod;
    }

    editTimeline.name = this.datasService.timelineAMod.name;
    editTimeline.category = this.datasService.timelineAMod.category;
    this.datasService.timelineAMod.update = new Date();
    this.timelineAMod = this.datasService.timelineAMod;
  }
  ...
  deleteTimelineCard(cardId: number) {
    ...
    console.log(this.datasService.timelineAMod);
    this.datasService.timelineAMod.updateDate = new Date();
    this.timelineAMod = this.datasService.timelineAMod;
  }
